...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        "JSON Workflow DSL + when/unless 条件跳过；混合模式路由；内置晨间/会议/审批/点名跟进。",
        "待补：循环节点、HTTP 步骤、可视化编辑。",
    ...
    Capability(
        ...
        "JSONL traces + feishu eval 汇总完成/失败事件。",
        "待补：按 run 查询 CLI、token 汇总（无 Web 台）。",
    ...
    Capability(
        ...
        "本地 HTML 报告（feishu report / report_write）+ 云文档/卡片/ArtifactTask；上传飞书仍走确认闸。",
        "待补：图片/音频产物与批量上传。",
        "https://www.feishu.cn/content/article/7585126677299137754",
    ),
    Capability(
